...
const {
    ...
    approveBooking,
    rejectBooking,
    logout,renderEditForm,updateListing,destroyListing,deleteReviewAsHost,renderHostAnalytics,viewListing,forgotPassword,showVerifyOtpForm,verifyOtp,resetPassword
